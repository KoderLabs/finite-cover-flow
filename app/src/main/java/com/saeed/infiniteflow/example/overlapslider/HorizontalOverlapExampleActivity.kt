package com.saeed.infiniteflow.example.overlapslider
...
import kotlinx.android.synthetic.main.activity_horizontal_overlap_example.*

class HorizontalOverlapExampleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_horizontal_overlap_example)
